...
import { CheckCircle2, Circle, Trash2, Plus, Tags, Folder, Layers, Mic, MicOff, Send, Sparkles, LogOut } from "lucide-react";
...
export default function DashboardPage() {
  ...
  if (isAuthLoading || !isAuthenticated) {
    return (
      <div className="flex flex-col h-screen max-w-md mx-auto bg-white shadow-xl relative overflow-hidden border-x border-slate-100 items-center justify-center gap-2">
      ...
      <header className="pt-10 pb-4 px-5 bg-gradient-to-br from-slate-900 to-slate-950 text-white shadow-sm shrink-0">
        <div className="flex items-start justify-between gap-2">
          ...
          <button
            ...
            title="Sign out"
            className="mt-1 p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/10 transition-colors shrink-0"
          >
